...
@main
struct RedeemDeckApp: App {
    private let sharedModelContainer: ModelContainer
    private let csvImporter: CSVImporter
    private let repository: RedeemDeckRepository
    private let migrationService: RedeemDeckMigrationService
    ...
    init() {
        ...
        repository = RedeemDeckRepository(modelContainer: container)
        migrationService = RedeemDeckMigrationService(modelContainer: container)
